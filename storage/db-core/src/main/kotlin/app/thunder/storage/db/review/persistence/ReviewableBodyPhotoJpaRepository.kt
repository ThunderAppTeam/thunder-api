...
internal fun ReviewableBodyPhotoJpaRepository.findFirstAllByMemberIds(memberIds: Collection<Long>): List<ReviewableBodyPhotoEntity> {
...
internal fun ReviewableBodyPhotoJpaRepository.findAllByMemberId(
    memberId: Long,
    limit: Int? = null,
