package app.thunder.storage.db.flag
...
import app.thunder.storage.db.flag.entity.FlagReason
import app.thunder.storage.db.flag.persistence.FlagHistoryJpaRepository
...
internal class FlagHistoryAdapter(
    ...
    private fun createAlreadyFlaggedException(): RuntimeException {
        return try {
            val bodyErrorsClass = Class.forName("app.thunder.api.exception.BodyErrors")
            val thunderExceptionClass = Class.forName("app.thunder.api.exception.ThunderException")
