...
internal interface DummyDeckPersistence : JpaRepository<DummyDeckEntity, Long>, KotlinJdslJpqlExecutor {
    fun findByMemberIdAndBodyPhotoId(memberId: Long, bodyPhotoId: Long): DummyDeckEntity?
}

internal fun DummyDeckPersistence.findAllByMemberIdOrderByCreatedAt(memberId: Long): List<DummyDeckEntity> {
    return this.findAll {
        select(
